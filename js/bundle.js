...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:4000/menu').then(data => {
...
function forms(formSelector, modalTimeId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:4000/requests', json)
        .then(data => {
          console.log(data);
...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
  ...
  next.addEventListener('click', () => {
    updateSlidePosition();
    updateSlideIndexNext();
    updateDotsOpacity();
  });

  prev.addEventListener('click', () => {
    updateSlideIndexPrev();
    updateDotsOpacity();
  });
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2025-03-10');
